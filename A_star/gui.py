...
COLOR_ID = ['R', 'W', 'A', 'B']  # order of cycling clicks
...
class Frame():
    ...
    def __init__(self, root, *args, **kwargs):
        ...
        self.queue = Queue()
        self.visu_speed = 4 # higher = faster. deteremines how fast the visualization runs
    ...
    def load(self):
        size, self.grid = alogs.read_file("input.txt")
        self.display_grid = [row[:] for row in self.grid]
